...
//  Block Callbacks
// ================================================================================================
typedef void (^TBXMLSuccessBlock)(HDTBXML *tbxml);
typedef void (^TBXMLFailureBlock)(HDTBXML *tbxml, NSError *error);
...
@interface HDTBXML (StaticFunctions)
