...
let package = Package(
    ...
    dependencies: [
     ...
     targets: [
        ...
        .binaryTarget(name: "KitabooSDKWithReader", url: "https://github.com/hardikhadwani-hurix/KitabooSDKWithReader/releases/download/1.0.6/KitabooSDKWithReader.xcframework.zip", checksum: "4f4a65e71ead29ff3c801d4213c3613831fb028a9252d5a498dbd6b9add35d02"),
        .target(
            name: "KitabooSDKWithReaderSPM",
            dependencies: [
