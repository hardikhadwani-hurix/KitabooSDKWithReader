...
let package = Package(
    ...
    dependencies: [
     ...
     targets: [
        ...
        .binaryTarget(name: "KitabooSDKWithReader", url: "https://github.com/hardikhadwani-hurix/KitabooSDKWithReader/releases/download/1.0.6/KitabooSDKWithReader.xcframework.zip", checksum: "58dc4444d27d0a0d666f82fa9a4c30457a54c4b9c5b47de57b5816a316a8e605"),
        .target(
            name: "KitabooSDKWithReaderSPM",
            dependencies: [
